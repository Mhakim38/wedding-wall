...
function GalleryContent() {
  ...
  // Check if family member name exists in sessionStorage
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-pink-50 dark:from-gray-900 dark:via-black dark:to-gray-900">
      {/* Family Member Name Modal */}
      {showNameModal && (
        <FamilyMemberNameModal 
          onNameSubmit={(name) => {
            sessionStorage.setItem(`current_family_member_${sessionId}`, name);
